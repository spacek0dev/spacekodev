    ...
    <div className="neoh_fn_filters">
      ...
      <div className={`filter_item filter__special ${special ? "" : "closed"}`}>
        ...
        <div className="filter_item__header">
          <a className="full_link c-pointer" onClick={() => setSpecial(!special)} />
      ...
      {/* !Special */}
      {/* Clothing */}
      <div className={`filter_item filter__clothing ${clothing ? "" : "closed"}`}>
        {/* Filter Header */}
        <div className="filter_item__header">
          <a className="full_link c-pointer" onClick={() => setClothing(!clothing)} />
