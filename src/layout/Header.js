          ...
          <div className="nav_menu">
            <ul>
              <li className="menu-item menu-item-has-children">
                ...
                <ul className="sub-menu" style={{ display: homeToggle ? "block" : "none" }}>
                  <li>
        ...
        {/* <div className={`nav_footer ${toggle ? "ready" : ""}`}>
          <div className="nf_left">
            <p>
              ...
              <a href="https://themeforest.net/user/codeefly/portfolio" target="_blank">
                Codeefly
              </a>
            </p>
          </div>
      ...
      <header className="neoh_fn_header">
        <div className="container">
          <div className="header_in">
            <div className="logo">
              <Link href="/">
                <h3 style={{ cursor: "pointer", margin: 0 }}>Alex Andre</h3>
